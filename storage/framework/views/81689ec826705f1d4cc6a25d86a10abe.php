...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Bubub Movie'); ?> — Bubub Movie</title>
...
<body>
    ...
    <nav class="navbar" id="mainNavbar">
        ...
        <div class="navbar-nav">
            <a href="<?php echo e(route('movies.index')); ?>" class="<?php echo e(request()->routeIs('movies.*') ? 'active' : ''); ?>">
                <?php echo e(__('nav.movies')); ?>

            </a>
            <a href="<?php echo e(route('favorites.index')); ?>" class="<?php echo e(request()->routeIs('favorites.*') ? 'active' : ''); ?>">
                <?php echo e(__('nav.favorites')); ?>
        ...
        <div class="navbar-right">
            ...
            <div style="position:relative;">
                <form id="navSearchForm" action="<?php echo e(route('movies.index')); ?>" method="GET" class="search-bar">
                    <i class="fas fa-search"></i>
                    <input type="text" id="navSearchInput" name="q" value="<?php echo e(request('q')); ?>" placeholder="<?php echo e(__('nav.search_placeholder')); ?>" autocomplete="off">
                </form>
...
<?php /**PATH D:\laragon\www\bubub-movie-baru\resources\views/layouts/app.blade.php ENDPATH**/ ?>