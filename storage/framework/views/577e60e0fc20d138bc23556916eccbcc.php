...
<head>
    ...
    <title><?php echo e(__('auth_ui.sign_in')); ?> — Bubub Movie</title>
...
<body>
    ...
    <div class="loading-overlay" id="loadingOverlay">
        ...
        <p><?php echo e(__('auth_ui.signing_in')); ?></p>
    </div>
    ...
    <div class="login-page">
        ...
        <div class="login-card">
            <div class="login-logo">
                ...
                <div class="logo-tagline"><?php echo e(__('auth_ui.tagline')); ?></div>
            </div>

            <h1 class="login-title"><?php echo e(__('auth_ui.welcome_back')); ?></h1>
            <p class="login-subtitle"><?php echo e(__('auth_ui.sign_in_to_continue')); ?></p>
            ...
            <form id="loginForm" action="<?php echo e(route('login')); ?>" method="POST" novalidate>
                <?php echo csrf_field(); ?>

                <div class="form-group">
                    <label class="form-label" for="username"><?php echo e(__('auth_ui.username')); ?></label>
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            placeholder="<?php echo e(__('auth_ui.username_placeholder')); ?>"
                ...
                <div class="form-group">
                    <label class="form-label" for="password"><?php echo e(__('auth_ui.password')); ?></label>
                    <div class="input-group">
                        <i class="fas fa-lock input-icon"></i>
                        <input
                            type="password" id="password" name="password"
                            class="form-input password-input <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error-input <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            placeholder="<?php echo e(__('auth_ui.password_placeholder')); ?>"
                ...
                <button type="submit" class="btn-login" id="submitBtn">
                    <span id="btnText"><?php echo e(__('auth_ui.sign_in')); ?></span>
                    <i class="fas fa-arrow-right" id="btnIcon"></i>
                </button>
            </form>

            <div class="demo-hint">
                <strong><?php echo e(__('auth_ui.demo_credentials')); ?>:</strong><br>
                <?php echo e(__('auth_ui.username')); ?>: <strong>aldmic</strong> &nbsp;|&nbsp;
                <?php echo e(__('auth_ui.password')); ?>: <strong>123abc123</strong>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.getElementById('loginForm').addEventListener('submit', function(e) {
            ...
            btn.disabled  = true;
            btnText.textContent = '<?php echo e(__("auth_ui.signing_in")); ?>';
...
<?php /**PATH D:\laragon\www\bubub-movie-baru\resources\views/auth/login.blade.php ENDPATH**/ ?>